...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<?php if($_SESSION['rol']==1){?><h1 class="h3 mb-0 text-gray-800">Panel de Administración</h1><?php }else{
			?><h1 class="h3 mb-0 text-gray-800">Panel de Ventas</h1> <?php }?>
	</div>
	...
	<div class="row">
		<div class="col-lg-6">
			<div class="card">
				<div class="card-header bg-primary bg-primary text-white">
					...
					<ul class="list-group">
						...
						<form action="" method=" post" name="frmChangePass" id="frmChangePass" class="p-3">
							...
							<div class="form-group">
								...
								<input type="password" name="confirmar" id="confirmar" placeholder="Confirmar clave" required class="form-control"><br>
							</div>
							<div class="alertChangePass" style="display:none;">
							</div>
							<div>
								<button type="submit" class="btn btn-primary btnChangePass btn-primary">Cambiar Contraseña</button>
							</div>
						</form>
					</ul>
				</div>
				...
				<div class="card">
					...
					<div class="card-body">
						<form action="empresa.php" method="post" id="frmEmpresa" class="p-3">
							...
							<div class="form-group">
								<label>IGV (%):</label>
								<input type="text" name="txtIgv" class="form-control" value="<?php echo $igv; ?>" id="txtIgv" placeholder="IGV de la Empresa" required><br>
							</div>

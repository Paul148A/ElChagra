...
if (!empty($_POST)) {
  $alert = "";
  if (empty($_POST['proveedor']) || empty($_POST['nombre_producto']) || empty($_POST['nombre_producto']) || empty($_POST['codbar']) || empty($_POST['precio']) || empty($_POST['precio_iva']) || empty($_POST['precio_iva']) || $_POST['precio'] <  0 || empty($_POST['stock'] || $_POST['stock'] <  0) || empty($_FILES['imagen']) || empty($_POST['codbar'])) {
    ...
    $estado = $_POST['estado'];
    $query_insert = mysqli_query($conexion, "INSERT INTO `producto`( `nombre_producto`, `detalles`, `proveedor`, `precio`, `precio_iva`, `stock`, `imagen`, `codigobar`, `categoria`, `estado`)values ('$producto', '$detalles', '$proveedor', '$precio', '$precio_iva', '$stock', '$img', '$barras', '$categoria', '$estado')");
    if ($query_insert) {
...
<div class="container-fluid">
  ...
  <div class="d-sm-flex justify-content-end ">
    <a href="lista_productos.php" class="btn btn-primary mx-3">Regresar</a>
        ...
        <?php echo isset($alert) ? $alert : ''; ?>
          ...
          <div class="row">
            <div class="col-5">
              ...
              <div class="form-group">
                <label for="precio">Precio Iva</label>
                <input type="text" placeholder="Ingrese precio" class="form-control" name="precio_iva" id="precio_iva">
              </div>
              <div class="form-group">
